...
TCTI_DECLARE_FP_BINARY_SEMANTIC_TEST(FMULDoubleMultipliesIEEE64Operands, 0x1e650883, 0x9209c,
                                     4, 5, 3, 0x4008000000000000ULL, 0x4000000000000000ULL,
                                     0x4018000000000000ULL)
TCTI_DECLARE_FP_BINARY_SEMANTIC_TEST(FDIVDoubleDividesIEEE64Operands, 0x1e6818e6, 0x920a0,
                                     7, 8, 6, 0x4010000000000000ULL, 0x4000000000000000ULL,
                                     0x4000000000000000ULL)
TCTI_DECLARE_FP_UNARY_SEMANTIC_TEST(FNEGNegatesIEEE64Operand, 0x1e614149, 0x920a4,
                                    10, 9, 0x4008000000000000ULL, 0xc008000000000000ULL)
TCTI_DECLARE_FP_UNARY_SEMANTIC_TEST(FABSClearsSignBitOfIEEE64Operand, 0x1e60c18b, 0x920a8,
