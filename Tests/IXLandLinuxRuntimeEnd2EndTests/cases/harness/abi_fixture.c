...
int run_abi_fixture(const char *case_yaml, const char *artifact_dir)
{
    ...
    /* Write report */
    if (write_report(artifact_dir, case_id, "04-mmu-abi", "abi_fixture", result == 0,
                     failure_reason) != 0) {
        return 1;
    }
