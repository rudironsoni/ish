 ...
 * Harness Runner API
 *
 * Declares the run_* entry points for all harness types.
...
/* iOS app harness - validates simulator app testing via XcodeBuildMCP */
int run_ios_app_harness(const char *case_yaml, const char *artifact_dir);

/* iOS fixture harness - validates iOS runtime fixtures */
