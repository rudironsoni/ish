...
static int write_distro_log(const char *artifact_dir, const char *case_id,
...
static int test_musl_001_static_busybox_true(const char *artifact_dir, char *log_buf, size_t log_size) {
    (void)artifact_dir;
    (void)log_size;
...
static int test_musl_002_dynamic_busybox_true(const char *artifact_dir, char *log_buf, size_t log_size) {
    (void)artifact_dir;
    (void)log_size;
...
static int test_musl_003_dynamic_busybox_sh(const char *artifact_dir, char *log_buf, size_t log_size) {
    (void)artifact_dir;
    (void)log_size;
...
static int test_musl_006_apk_install_tiny_package(const char *artifact_dir, char *log_buf, size_t log_size) {
    (void)artifact_dir;
    (void)log_size;
...
static int test_musl_007_musl_pthread_smoke(const char *artifact_dir, char *log_buf, size_t log_size) {
    (void)artifact_dir;
...
static int test_musl_008_musl_network_smoke(const char *artifact_dir, char *log_buf, size_t log_size) {
    (void)artifact_dir;
...
#else
    int has_coreutils = 0;
    if (access("/bin/ls", F_OK) == 0) has_coreutils = 1;
    if (access("/usr/bin/ls", F_OK) == 0) has_coreutils = 1;
...
int main(int argc, char *argv[]) {
    ...
    /* Write report */
    if (write_report(artifact_dir, case_id, phase, "distro_fixture",
                     result == 0, failure_reason, platform_note) != 0) {
        return 1;
    }
