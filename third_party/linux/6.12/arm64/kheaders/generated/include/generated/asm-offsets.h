...
#define TSK_STACK_CANARY 1224 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 2704 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 4352 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 4248 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 4328 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 4344 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define VCPU_FAULT_DISR 3424 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
...
#define TRAMP_VALIAS -10526720 /* TRAMP_VALIAS */
